...
if ($contar > 0) {
    ...
    $sql_agregar = 'INSERT INTO contactos (nombre,primerApellido,segundoApellido,desarrollo,telefono,email,pais,campana,asesor)
     VALUES (?,?,?,?,?,?,?,?,?)';
    $sentencia_agregar = $pdo->prepare($sql_agregar);
    $sentencia_agregar->execute(array($nombre, $primerApellido, $segundoApellido, $desarrollo, $telefono, $email, $pais, $campaña, $asesor));
